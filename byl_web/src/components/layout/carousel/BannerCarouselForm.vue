<!-- 이 캐러셀은 화면 좌우를 여백 없이 꽉 채우는 디자인이라 배너용으로 적합합니다
공용 컴포넌트로 만들었기 때문에 다른 컴포넌트에서 import 할 때 props 설정만 바꿔주면 다양하게 재사용할 수 있습니다 -->
<template>
  <div>
    <v-carousel cycle="cycle" :interval="inverval" :width="carouselWidth" :height="carouselHeight" hide-delimiters="hideDelimiters">
