 ...
 <div class="product-list-form">
  <div class="sticky-bar">
    ...
    <v-container>
      ...
      <v-row>
        <v-col v-for="(item, i) in sortedProducts" :key="i" cols="12" sm="4" md="3" class="product-col">
...
export default {
  ...
  data() {
    return {
      ...
      recentItems: [
        { img: "https://via.placeholder.com/200x200", name: "상품 1", price: "10,000" },
      ],
      products: [
        { img: "https://via.placeholder.com/200x200", name: "상품 1", price: "10,000", category: "카테고리1" },
        { img: "https://via.placeholder.com/200x200", name: "상품 2", price: "20,000", category: "카테고리2" },
